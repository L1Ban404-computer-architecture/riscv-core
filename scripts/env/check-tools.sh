...
check_cmd verible-verilog-format print_version_line verible-verilog-format --version
check_cmd verible-verilog-lint print_version_line verible-verilog-lint --version
check_cmd verible-verilog-ls print_version_line verible-verilog-ls --version
