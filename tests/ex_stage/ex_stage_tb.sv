...
module ex_stage_tb (
  ...
  input logic [2:0] id_ex_wb_sel_i,
  ...
  always_comb begin
    ...
    id_ex_bus.exception.valid = id_ex_illegal_instr_i;
    id_ex_bus.exception.cause = EXC_ILLEGAL_INSTR;
    id_ex_bus.exception.tval = id_ex_instr_i;
  end
